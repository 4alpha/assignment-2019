...
<body>
	<div class="container">
		...
		<form class="form-group" method="post" enctype="multipart/form-data">
            ...
            <label for="exampleInputEmail">Enter Your Registered Email</label>
            ...
            <input type="text" class="form-control" name="surname" pattern="[a-zA-Z]*">
            <br>
			...
			<input class="btn btn-outline-primary" type="submit" name="update" value="Confirm Update">
